...
import com.example.broadcast.MyBroadcastReceiver;
...
public class MainActivity extends AppCompatActivity implements IOnScreenReceived, OnFireMissile {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bDIALOG.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new FireMissilesDialogFragment().show(getSupportFragmentManager(), "missiles TAG");
            }
        });
        ...
        bOPEN.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                startService(new Intent(MainActivity.this, TouchDetectService.class));
...
//        intent.putExtra("EndHour", 2);
//        intent.putExtra("EndMinute", 3);
//        intent.putExtra("MinutiPermessi", 4);
//        intent.putExtra("TipoNotifica",5);
//        Intent intent2 = new Intent(context, FasciaOrariaExecutor.class);
//
//        Log.i(TAG, "Result = "+intent.filterEquals(intent2));
...
//        FasciaOrariaHandler foh = new FasciaOrariaHandler(MainActivity.this);
//        foh.addFasciaOraria(FasciaOraria.newInstance(10, "SLEEP", true, 12, 30, 15, 0, 15, FasciaOraria.NOTIFICATION));
//        FasciaOraria fo = new FasciaOraria();
//        foh.addFasciaOraria(fo);
//        fo.setName("Modified");
//
//        for ( FasciaOraria f: foh ) {
...
//        foh.printList(TAG);
    ...
    private void initPersonalIntentButton() {
        myReceiver = new MyBroadcastReceiver();

        // Bind il BR e l'intent che ci interessa
        IntentFilter _if = new IntentFilter(getString(R.string.my_special_action));
        registerReceiver(myReceiver, _if);

        bSEND.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String _s = etMsg.getText().toString();

                // creo e lancio l'intento con la stessa azione su cui e' registrato MyBroadcastReceiver
                Intent _i = new Intent(getString(R.string.my_special_action));
                _i.putExtra(getString(R.string.MSG_STRING), _s);
                sendBroadcast(_i);
            }
        });
    }
    ...
    public void fire() {
        ...
        new FireMissilesDialogFragment().show(getSupportFragmentManager(), "missiles by notification TAG");
    }
